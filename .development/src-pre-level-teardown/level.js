	...
	if (l == 0) { // Title sequence
      ...
      // FIXME cheat code
		...
		charMap.display = function() {
			image(this.img, this.getImgLeft(), this.getImgTop(), this.imgSize.x, this.imgSize.y / 2);
			image(this.img, this.getImgLeft(), this.getImgTop() + this.imgSize.y / 2, this.imgSize.x, this.imgSize.y / 2);
		}
